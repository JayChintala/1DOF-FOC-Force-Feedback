...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOC, CAN_SHDN_Pin, GPIO_PIN_RESET);   /* LOW = normal mode */
  HAL_GPIO_WritePin(GPIOC, CAN_TERM_Pin, GPIO_PIN_SET);      /* keep as-is if you want termination ON — confirm against Table 3 in UM2516 */
